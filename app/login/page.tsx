        ...
        <div className="bg-surface rounded-xl shadow-lg p-6 space-y-4">
          ...
          {!devMode && (
            <button
              ...
              className="w-full flex items-center justify-center gap-3 py-2.5 bg-white border border-gray-300 text-gray-700 text-sm font-medium rounded-lg hover:bg-gray-50 transition-colors disabled:opacity-50"
            >
          ...
          {!devMode && (
            <div className="relative">
              ...
              <div className="relative flex justify-center text-xs">
                <span className="bg-surface px-2 text-text-muted">or sign in with email</span>
              </div>
            </div>
          )}
